...
set screenshot_quiet 0

echo "[spectator] spectator.cfg loaded"

// Keep the HUD out of the way.
set screenblocks 12

// Take a shot, always overwriting /screenshot.png
alias _spectator_shot "echo [spectator] taking screenshot...; spectate; spyrandom; wait 5; screenshot screenshot.png; wait 1"
